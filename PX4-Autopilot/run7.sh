...
cd ~/Desktop/com1_github/PX4-Autopilot &&
...
source /opt/ros/humble/setup.bash &&
source ~/gz_ws/install/setup.bash &&
cd ~/Desktop/com1_github/PX4-Autopilot/navigation &&
...
source /opt/ros/humble/setup.bash &&
source ~/Desktop/com1_github/ws_px4_msgs/install/setup.bash &&
cd ~/Desktop/com1_github/PX4-Autopilot/New_code &&
python3 main.py;
exec bash
"
